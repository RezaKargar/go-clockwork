...
// Cache defines the minimal cache behavior required by WrapCache.
...
// WrapCache wraps cache operations with Clockwork instrumentation.
func WrapCache(underlying Cache) Cache {
	if underlying == nil {
		return nil
	}
